...
- (void)playWithUrl:(NSURL *)url showView:(UIView *)showView{
    ...
    if ([manager fileExistsAtPath:path]) {
        ...
        self.currentPlayerLayer.frame = CGRectMake(0, 0, _showView.bounds.size.width + 40, _showView.bounds.size.height);
    }
    else{
        ...
        self.player = [AVPlayer playerWithPlayerItem:playerItem];
        self.currentPlayerLayer = [AVPlayerLayer playerLayerWithPlayer:self.player];
        self.currentPlayerLayer.frame = CGRectMake(0, 0, showView.bounds.size.width + 40, showView.bounds.size.height);
    }
}
