...
- (CALayer *)lineLayer{
    if (!_lineLayer) {
        ...
        _lineLayer.backgroundColor = [UIColor colorWithRed:239/255.0 green:237/255.0 blue:237/255.0 alpha:1].CGColor;
...
- (void)layoutSubviews{
    ...
    self.lineLayer.frame = CGRectMake((self.bounds.size.width - 1) / 2, 10, 1, (self.bounds.size.height - 20));
}
