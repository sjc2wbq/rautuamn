...
//    self.collectionView.contentInset = UIEdgeInsetsMake(spacing, 0, 50 + spacing, 0);
//    self.collectionView.scrollIndicatorInsets = self.collectionView.contentInset;
    ...
    HXPhotoBottomView *bottomView = [[HXPhotoBottomView alloc] initWithFrame:CGRectMake(0, heght - 50-64, width, 50)];
