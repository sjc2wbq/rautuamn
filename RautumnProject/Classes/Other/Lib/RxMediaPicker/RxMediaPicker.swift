...
@objc open class RxMediaPicker: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIAlertViewDelegate {
    ...
    fileprivate func processVideo(url: URL, observer: AnyObserver<URL>, maxDuration: TimeInterval, picker: UIImagePickerController) {
        ...
        if duration > maxDuration {
            ...
            observer.on(.completed)
            let alertController = UIAlertController(title: "提示", message: "视频时长必须小于\(maxDuration)秒，请重新选择！", preferredStyle: .alert)
