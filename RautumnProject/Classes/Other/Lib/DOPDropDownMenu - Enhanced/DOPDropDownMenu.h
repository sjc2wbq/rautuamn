...
@interface DropMenuModel : NSObject
@property(nonatomic,strong) NSString * text;
@property(nonatomic,assign,getter=isSelected) bool seleted;
 ...
 */
- (DropMenuModel *)menu:(DOPDropDownMenu *)menu titleForRowAtIndexPath:(DOPIndexPath *)indexPath;
 ...
 *  如果都没有可以不实现该协议
 */
- (DropMenuModel *)menu:(DOPDropDownMenu *)menu titleForItemsInRowAtIndexPath:(DOPIndexPath *)indexPath;
...
- (void)menu:(DOPDropDownMenu *)menu didClickeDoneButton:(UIButton *)button;
