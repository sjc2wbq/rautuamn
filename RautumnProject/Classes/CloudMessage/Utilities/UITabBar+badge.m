...
- (void)showBadgeOnItemIndex:(int)index{
  ...
  //确定小红点的位置
  float percentX = (index +0.45) / TabbarItemNums;
 ...
 */
  ...
  CGFloat y = ceilf(0.1 * tabFrame.size.height);
    if (badgeValue <= 0) {
        [self initUnreadCountButton:CGRectMake(x, y, 12, 12) tag:888+index badgeValue:badgeValue];
    }else
