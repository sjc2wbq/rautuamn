...
- (void)initMapView
{
    _mapView = [[MAMapView alloc] initWithFrame:CGRectMake(0,0, [UIScreen mainScreen].bounds.size.width,  [UIScreen mainScreen].bounds.size.height - LABEL_HEIGHT)];
...
- (void)initTitleLabel
{
    UIView *backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_mapView.frame),  [UIScreen mainScreen].bounds.size.width, LABEL_HEIGHT)];
    backgroundView.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:backgroundView];
    
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 15,  [UIScreen mainScreen].bounds.size.width - 15, 22)];
    titleLabel.text = _title;
    titleLabel.font = [UIFont systemFontOfSize:22];
    titleLabel.textColor = [UIColor blackColor];
    [backgroundView addSubview:titleLabel];
    
    UILabel *detailLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(titleLabel.frame)+12,  [UIScreen mainScreen].bounds.size.width - 15, 16)];
